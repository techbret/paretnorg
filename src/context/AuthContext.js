...
export default function AuthContextProvider({ children }) {
    ...
    const studentSignIn = (token, userName) => {
        return signInWithCustomToken(auth, token, userName);
    };
    ...
    return (
        <UserContext.Provider value={{ createUser, signIn, logout, createStudent, profile, updateUser, isLoggedIn, students, updateStudent }}>
            {children}
