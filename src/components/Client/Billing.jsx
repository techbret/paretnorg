...
const plans = [
  { name: 'Home School Individual License', priceMonthly: 79, priceYearly: 850, limit: 'Up to 2 students' },
  { name: 'Small Group License', priceMonthly: 129, priceYearly: 1350, limit: 'Up to 25 students' },
  { name: 'Enterprise', priceMonthly: 450, priceYearly: 5000, limit: 'Professional Grading Up to 100 students' },
]
const payments = [
  {
    id: 1,
  ...
  return (
    <>
      ...
      */}
      ...
      <h1 className='text-2xl text-center font-bold pt-8'>Update your billing information</h1>
                            <h3 className='text-center text-lg'>If you have any questions or need more information please reach out to us at <span className='text-orange-500'>support@readingmastery.org</span></h3>
                      ...
                      <div className="mt-6 grid grid-cols-4 gap-6">
                        ...
                        <div className="col-span-4 sm:col-span-2">
                          ...
                          <input
                            ...
                            className="mt-1 block w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:border-gray-900 focus:outline-none focus:ring-gray-900 sm:text-sm"
                          />
                          <p className='text-gray-600 text-xs'>*We do not save your credit card information. All billing is handled through <a href="stripe.com" className='text-indigo-500'>Stripe</a> </p>
                        </div>
